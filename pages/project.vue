...
name: "project",
  ...
  data() {
    return {
      ...
      date: "JAN, 2020",
      textContent:{
        firstText:"Milton Glaser was among the most celebrated graphic designers in the United States. He has had the distinction of one-man-shows at the Museum of Modern Art and the Georges Pompidou Center. He was selected for the lifetime achievement award of the Cooper Hewitt National Design Museum (2004) and the Fulbright Association (2011).",
        secondText:"This project had the objective of reproducing the designer’s style to create a visual identity for a retrospective exhibition using typographic techniques and generating promotional items for the visitors of the exhibition.",
        thirdText: "By identifying the style of Milton Glaser, the use of colour and illustration, this idea arose from the major retrospective exhibition, Colour Icon. My promotional idea was to use illustration patterns inside glasses representing how Milton Glaser saw the world and together with his inspirations for his designs.",
        quarterText:"The challenge here was to create various patterns and play together with typography, generating beautiful and memorable pieces of design. Also, we had to make promotional items for the visitors and advertising the gallery"
      },
      images:{
